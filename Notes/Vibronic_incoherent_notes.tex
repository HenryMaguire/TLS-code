...
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{"/Users/henrymaguire/Documents/phd-work/vibronic-TLS/Notes/Images/Dynamics/Pop_a300_N6_Tem6000_w050_eps10000".pdf}
	\caption{Population where $\alpha=300$, $T_{EM} =6000$, $\omega_0 = 50$, $\epsilon=10000$}
	\label{}
\end{figure}
\begin{figure}[h]
	\centering
	\includegraphics[width=\textwidth]{"/Users/henrymaguire/Documents/phd-work/vibronic-TLS/Notes/Images/Dynamics/Pop_a300_N6_Tem6000_w0300_eps".pdf}
	\caption{Population where $\alpha=300$, $T_{EM} =6000$, $\omega_0 = 50$, $\epsilon=2000$}
	\label{}
\end{figure}
