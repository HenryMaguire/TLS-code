...
def L_ph(sigma, eps, beta, wc, w0, alpha_ph, time_units='cm'):
    A = sigma.dag()*sigma
    Gamma = (w0**2)/wc
...
if __name__ == '__main__':
    ...
    wc = 0.1*eps #53. # Ind.-Boson frame phonon cutoff freq
    #wc = 53.*0.188
    w0 = 300. # underdamped SD parameter omega_0
    #w0 = 200.*0.188
    alpha_ph = 0.01*eps/np.pi#(10./np.pi)# Ind.-Boson frame coupling
    beta = 0.95/eps #1/(0.695*T_ph)
    ...
    timelist = np.linspace(0,20/eps,10000)#*0.188
    #print H_S, rho_init
