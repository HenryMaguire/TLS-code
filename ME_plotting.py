...
def calculate_dynamics(eps, w0, wc, alpha_ph, T_ph, alpha_EM, T_EM, N):
    # Firstly make the RC liouvillian and Hamiltonian

    return timelist, DATA_nrwa, DATA_ns, DATA_s, DATA_naive, H, A_EM
